...
Page({
	...
	onLoad: function(options) {
		...
		let themeListUrl = app.globalData.dataUrl.explosivelyUrl + "?page=" + this.data.page + "&type=0&supplier=pin"
	...
	onShareAppMessage: function () {
		...
		let path = 'pages/freeshipping/freeshipping'
		if(userInfo.istg == 1){
			path = 'pages/freeshipping/freeshipping?tcode=' + userInfo.tcode
		}
		return {
			title: '1.9包邮',
			path: path
	...
	onReachBottom: function(event) {
		var nextUrl = app.globalData.dataUrl.explosivelyUrl + "?page=" + this.data.page + "&type=0&supplier=pin"
